...
*/
function addTwoToArray(arrayofnumbers) {
  let newarr = [];
  for(let i = 0; i < arrayofnumbers.length; i++){
    newarr.push(addTwo(arrayofnumbers[i]))
  }
  return newarr;
}
addTwoToArray([1,2,3,4]);
/*
...
function addTwoToArray(arrayofnumbers) {
  let newarr = [];
  for(let i = 0; i < arrayofnumbers.length; i++){
    newarr.push(addThree(arrayofnumbers[i]))
  }
  return newarr;
}
addTwoToArray([1,2,3,4]);
/*
  Create a function named addFiveToArray which accepts:
    ...
    - while doing so use the funciton addThree
*/
function addFiveToArray(arrayofnumbers) {
  let newarr = [];
  for(let i = 0; i < arrayofnumbers.length; i++){
    newarr.push(addFive(arrayofnumbers[i]))
  }
  return newarr;
}
addFiveToArray([1,2,3,4]);
/*
...
*/
function sendMessage(stringMessage, cb) {
  return cb(stringMessage)
}
/*
...
function name() {
  return 'My name is abhishek'
}
let call = callMe(name);
call(name)
...
function isGradeB(object) {
  if(object.grade > 12 && object.grade <= 12) {
    return true
  }else {
    return false
  }
...
*/
function filterAdult(arrayofobjects) {
  let newarr = [];
  for(let i = 0; i < arrayofobjects.length; i++) {
    if(isAdult(arrayofobjects[i])) {
      newarr.push(arrayofobjects[i])
    }
  }
  return newarr;
}
...
*/
function filterMale(arrayofobjects) {
  let newarr = [];
  for(let i = 0; i < arrayofobjects.length; i++) {
    if(isMale(arrayofobjects[i])) {
      newarr.push(arrayofobjects[i])
    }
  }
  return newarr;
...
*/
function filterFemale(arrayofobjects) {
  let newarr = [];
  for(let i = 0; i < arrayofobjects.length; i++) {
    if(isFemale(arrayofobjects[i])) {
      newarr.push(arrayofobjects[i])
    }
  }
  return newarr;
...
*/
function filterGradeA(arrayofobjects) {
  let newarr = [];
  for(let i = 0; i < arrayofobjects.length; i++) {
    if(isGradeA(arrayofobjects[i])) {
      newarr.push(arrayofobjects[i])
    }
  }
  return newarr;
...
*/
function filterGradeB(arrayofobjects) {
  let newarr = [];
  for(let i = 0; i < arrayofobjects.length; i++) {
    if(isGradeB(arrayofobjects[i])) {
      newarr.push(arrayofobjects[i])
    }
  }
  return newarr;
...
*/
function filterGradeC(arrayofobjects) {
  let newarr = [];
  for(let i = 0; i < arrayofobjects.length; i++) {
    if(isGradeC(arrayofobjects[i])) {
      newarr.push(arrayofobjects[i])
    }
  }
  return newarr;
...
*/
function filter(arrayofobjects, cb) {
  let newarr = [];
  for(let i = 0; i < arrayofobjects.length; i++) {
    if(cb(arrayofobjects[i])) {
       newarr.push(arrayofobjects[i]);
    }
  } 
  return newarr;
